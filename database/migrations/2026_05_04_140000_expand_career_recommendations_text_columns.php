...
return new class extends Migration
{
    ...
    public function down(): void
    {
        ...
        DB::statement("ALTER TABLE `career_recommendations` MODIFY `reason` VARCHAR(255) NULL");
        DB::statement("ALTER TABLE `career_recommendations` MODIFY `metadata` VARCHAR(255) NULL");
    }
};
